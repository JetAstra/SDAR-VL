    ...
    if model is None and not lazy_load:
        ...
        if model_args.mixture_of_depths == "load":
            ...
            if model_args.train_from_scratch:
                ...
                # import sys
                # sys.path.append("/mnt/shared-storage-user/dllm-share/chengshuang/sdar_v_ckpt/sdar_v_4b_t_beta_scheduler_0_8/sdar_v_4b_stage3_1")
                # from modeling_llava_onevision import LlavaOnevisionForConditionalGeneration
                # model = LlavaOnevisionForConditionalGeneration.from_pretrained(**init_kwargs)
